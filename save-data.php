...
// Portfolio SENGAJA tidak lagi ditangani di sini -- dipindah ke
// edit-portfolio.php (form PHP tradisional per-baris, pola whole-array-
// replace di endpoint ini pernah jadi sumber bug penyimpanan foto yang
// tidak konsisten).
$allowedSections = ['business', 'areas', 'faq', 'testimonials', 'area_photos'];
